...
void MagicRegen()
{
	G[G_MPREGEN] += (6 + 128/Hero->MaxMP*(Hero->MaxMP - Hero->MP)/(100/Hero->MaxMP*Hero->MP <= 25 ? 8 : 12))*G[G_MAGIC]/100; //Calculates magic that should be regend this frame. This formula could do with some further tweaking
