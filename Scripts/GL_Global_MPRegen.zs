...
void MagicRegen()
{
	G[G_MPREGEN] += G[G_MAGIC] + 128/Hero->MaxMP*(Hero->MaxMP - Hero->MP)/(100/Hero->MaxMP*Hero->MP <= 25 ? 8 : 12); //Calculates magic that should be regend this frame. This formula could do with some further tweaking
